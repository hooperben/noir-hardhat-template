// Verification Key Hash: 93533e801c706c166b7748569a7b6624cf51ff0edd932503a5ead6006b5c40b2
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0x93533e801c706c166b7748569a7b6624cf51ff0edd932503a5ead6006b5c40b2;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x07979c59853db43249c7f051cba12dd710bf2e9627db6484b4179f8dc2a721a6) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x09ef5adf8fd4f9a9756f58bcf90cf498af2ca08ead195e8fc5e2ee60694cbb44) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x1f4696a157a60658fdcce6a7a0ea0ebd9f1dcc3f6637395c8717f513a411c300) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x1b9d34fb632997c32d4289f10f64cf4ab71daa3daa3ff7515478c6a49cfb2ad1) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x0b26407bcb112b3f67c0e30e6628654528cfd03317294d038bd967025786f70f) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x2450328b35b6092eb7bea58562ed0766c162b4d6e374da5399cd620cc9791937) // vk.Q3.y
            ...
            mstore(add(_vk, 0x180), 0x0e842328da2cff90634b806ad77cd024ac366faa6125c2099dcb41411f6a1089) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x2d2c44d1219e6f8bd6ee7623a5e610fa39681975ee97bb361d484ca072146027) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x10f7e0783a53e81caa384f02046561a94324f6cddf9aa65ad47ef4778bf5aa61) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x1a34353e26d068b52621633cc726a417d2377c0ef6e6268f2906095141f69d30) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x2ce384be3b7df5852077b1c531f16fb9b78f3227a0fcca81e873e069186f2bb0) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x0862267714e24cbf15b5644f9b38d7599a8db9891ffa4f00867143b9c8bad197) // vk.Q_ARITHMETIC.y
            ...
            mstore(add(_vk, 0x300), 0x176794a15861d82fd6f1467963a934f238c32692966acf193556fb5e57477a48) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x249eb1a706d4c2394a7994b77dcfe3148b737cdf8526960042193990ce2482be) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x1799b430fa4cfd971c5ce99d8aa8df8e631f854933761e8db9d674a77efb8385) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x1114bde5e1d2ce52b557837c8d6cd4d3a926acdf03c678585c5bddffa1f67e27) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x257af7057275a812b2d3094c7ec7fbcb4b668c6eb689c2fdfcb298c3c2399acc) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x22c262e31f4de5269080bdd3956076cbcfe8e1731fe0ea79dde7809cf899a270) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x0116077bca863260cbdb8897dd2e42dcb02f7ce97da7f320924965a0f8948a64) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x29cbbc9591da7fbfe557042743d577de205e9d54f73282c750c8e1d588f9fcc3) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x580), 0x03be529e35e1c7259c8af3af6099814efa05287d68e60743fdc97dab48ccf21a) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x2f7264c778799e51f0667d0f2c9cbbfcb89ad8a99ad4f6fd245b9074520980a6) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x13bb3ea3918c7eb64e61c3d90c897477ad7b12008ca8f1239da25438dbba7a3c) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x1e7700af5ba0ce8f7eab47ebaa5683aa8fd2b26730f65536dfb8ec74eb172976) // vk.ID3.y
...
contract ConnectivityVerifier is BaseUltraVerifier {

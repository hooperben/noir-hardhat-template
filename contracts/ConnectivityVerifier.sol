...
contract ConnectivityVerifier {
  ...
  function verify(bytes calldata) external view returns (bool result) {
    ...
    Types.G1Point memory linearised_contribution = PolynomialEval
      .compute_linearised_opening_terms(challenges, L1, vk, decoded_proof);
    ...
    uint256 batch_evaluation_g1_scalar = PolynomialEval
      .compute_batch_evaluation_scalar_multiplier(decoded_proof, challenges);
    ...
    returns (Types.VerificationKey memory)
  {
    ...
    assembly {
      ...
      mstore(
        mload(add(vk, 0xa0)),
        0x3053d3284c77d41e8df7fe97a486a15d1f4b728f6d3ed7a2bd230254da9f54ae
      ) //vk.Q1
      mstore(
        add(mload(add(vk, 0xa0)), 0x20),
        0x2f94dd5d2e27f84ae958f2d0a4b73b64ca6189cf252a45f41575445113e7db3c
      )
      mstore(
        mload(add(vk, 0xc0)),
        0x18dabc1bfd7e9441b50c41ef73979b73a9595e67fce8baa81f51eff397bd8024
      ) //vk.Q2
      mstore(
        add(mload(add(vk, 0xc0)), 0x20),
        0x224598af4cc0daec322b79f679556600b479ac8c1f70becc6adafbd522c1c218
      )
      mstore(
        mload(add(vk, 0xe0)),
        0x264ab6636e5c1afeb02a26cd15a480b3309f355223871f4b27a27a6813a3e13c
      ) //vk.Q3
      mstore(
        add(mload(add(vk, 0xe0)), 0x20),
        0x1d3c54da6aebfcda2e408482a9fe4052123c71d37f88730df991f4d26b297d67
      )
      mstore(
        mload(add(vk, 0x100)),
      ...
      mstore(
        mload(add(vk, 0x140)),
        0x0e842328da2cff90634b806ad77cd024ac366faa6125c2099dcb41411f6a1089
      ) //vk.QM
      mstore(
        add(mload(add(vk, 0x140)), 0x20),
        0x2d2c44d1219e6f8bd6ee7623a5e610fa39681975ee97bb361d484ca072146027
      )
      mstore(
        mload(add(vk, 0x160)),
        0x1a11bdab573373566e3a886afef99b7c839d756b6b6ccc5e19e602eaa8ec921d
      ) //vk.QC
      mstore(
        add(mload(add(vk, 0x160)), 0x20),
        0x112413bd08118767f9f24a2c2f3b3fc934b55f6d6e05aa9ae58e58788566b753
      )
      mstore(
        mload(add(vk, 0x180)),
        0x20c490fd11d21e23b135faaac8d178e13e874c709d3569e9a6291b5e9bae832b
      ) //vk.QARITH
      mstore(
        add(mload(add(vk, 0x180)), 0x20),
        0x0e283862c50f9719c7bbbd43b29d2171dd76373e50dfcb8132f2c3610b9324e9
      )
      mstore(
        mload(add(vk, 0x1a0)),
        0x2950076760523510abcfe90fa550b964e84b338f73af5222cdbbaefdacd4484e
      ...
      mstore(
        mload(add(vk, 0x200)),
        0x2ebd09da194fe43b4c1109a2a5832b67bc40427c71febae4288243d77869750f
      ) //vk.SIGMA1
      mstore(
        add(mload(add(vk, 0x200)), 0x20),
        0x2cb10d85cc7cc54fa057840ebe26ef68496a93cf04692ed9251c9408aa04bf63
      )
      mstore(
        mload(add(vk, 0x220)),
        0x27f0e060d6b76cb4be9114daa88af23568e54623860467b0c37361c86bf55e11
      ) //vk.SIGMA2
      mstore(
        add(mload(add(vk, 0x220)), 0x20),
        0x249f464b8410f8706a130f3aa8e3b9f042da5cd4052eb67189db874c76f7f57a
      )
      mstore(
        mload(add(vk, 0x240)),
        0x1cede5533face92ab95d6c516ed703868ab9d008d56267d7b5bcc1c08198c152
      ) //vk.SIGMA3
      mstore(
        add(mload(add(vk, 0x240)), 0x20),
        0x2b9945db668f103855ac323354d62c8634eab28f9e0f50fb6f4176d103cbc9c2
      )
      mstore(
        mload(add(vk, 0x260)),
        0x1a2b1403291d80ea6ffdb22226c32d0409288e288945cca26a7eabdfe9d8e5be
      ) //vk.SIGMA4
      mstore(
        add(mload(add(vk, 0x260)), 0x20),
        0x0c8527e6817b660e4b923b9c7d2b4b2c2b06fd8cf6be63153347e44093ea6dd1
      )
  ...
  function perform_pairing(
    ...
    // scope this block to prevent stack depth errors
    {
      ...
      assembly {
        ...
        success := and(
          success,
          staticcall(gas(), 7, add(mPtr, 0x40), 0x60, add(mPtr, 0x40), 0x40)
        )
        success := and(success, staticcall(gas(), 6, mPtr, 0x80, mPtr, 0x40))
...
library PolynomialEval {
  ...
  function compute_pedersen_gate_quotient_contribution(
...

    {
      ...
      assembly {
        ...
        t2 := addmod(sub(p, mulmod(selector_value, delta, p)), wire_t2, p)
  ...
  function compute_batch_opening_commitment(
    ...
    assembly {
      ...
      success := and(
        success,
        staticcall(gas(), 6, accumulator_ptr, 0x80, accumulator_ptr, 0x40)
      )
    }
  ...
  function compute_grand_product_opening_group_element(
    ...
    }
    {
      ...
      assembly {
        ...
        partial_grand_product := mulmod(
          ...
          addmod(mulmod(mulmod(zeta, 0x05, p), beta, p), witness_term, p),
          p
        )
    ...
    }
    {
      ...
      assembly {
        ...
        partial_grand_product := mulmod(
          partial_grand_product,
          addmod(mulmod(mulmod(zeta, 0x06, p), beta, p), witness_term, p),
          p
        )
    ...
    }
    {
      ...
      assembly {
        partial_grand_product := mulmod(
          partial_grand_product,
          addmod(
            addmod(mulmod(mulmod(zeta, 0x07, p), beta, p), gamma, p),
            w4,
            p
          ),
          p
      ...
      assembly {
        ...
        sigma_multiplier := mulmod(
          sub(
            p,
            mulmod(
              mulmod(sigma_multiplier, grand_product_at_z_omega, p),
              alpha_base,
              p
            )
          ),
